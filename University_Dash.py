...
st.metric("Total Science Enrollees", {student_df['Science'].sum()})
st.metric("Total Engineering Enrollees", {student_df['Engineering'].sum()})
st.metric("Total Business Enrollees", {student_df['Business'].sum()})
st.metric("Total Arts Enrollees", {student_df['Arts'].sum()})
